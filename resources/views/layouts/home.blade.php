		...
		<div class="header_content_home">
			...
			<div class="home_nav">
				<ul>
					...
					<li class="link-braces"><a id="white_nav" href="{{ url('about-us') }}">about us</a></li>
					<li class="link-braces"><a id="white_nav" href="{{ url('service') }}">service</a></li>
					<li class="link-braces"><a id="white_nav" href="{{ url('study-overseas') }}">study overseas</a></li>
					<li class="link-braces"><a id="white_nav" href="{{ url('contact-us') }}">contact us</a></li>
				</ul>
			</div>
		</div>
	</header>
