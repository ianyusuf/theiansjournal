	...
	<div class="super_container">
		<header class="header_home" id="desktop-only">
			<div class="header_content_home">
				<div class="logo_container">
					<a href="{{ url('/') }}">
						<div class="logo"><img src="img/tj-logo.png" class="img-responsive" id="logo"></div>
					</a>
				</div>
				<div class="home_nav">
					<ul>
						<li class="link-braces"><a href="{{ url('/') }}">home</a></li>
						<li class="link-braces"><a href="{{ url('about') }}">session</a></li>
						<li class="link-braces"><a href="{{ url('service') }}">lifestyle</a></li>
						<li class="link-braces"><a href="{{ url('overseas') }}">booking</a></li>
						<li class="link-braces"><a href="{{ url('gallery') }}">column</a></li>
						<li class="link-braces"><a href="{{ url('contact') }}">contact</a></li>
					</ul>
				</div>
			</div>
		</header>
		...
		<header class="header" id="mobile-only">
			<div class="header_content">
				<div class="logo_container">
					<a href="{{ url('/') }}">
						<div class="logo"><img src="img/prince-logo.png" class="img-responsive" id="logo"></div>
					</a>
				</div>
				<div class="home_nav">
					<ul>
						<li class="link-braces"><a id="white_nav" href="{{ url('/') }}">home</a></li>
						<li class="link-braces"><a id="white_nav" href="{{ url('about') }}">session</a></li>
						<li class="link-braces"><a id="white_nav" href="{{ url('service') }}">lifestyle</a></li>
						<li class="link-braces"><a id="white_nav" href="{{ url('overseas') }}">booking</a></li>
						<li class="link-braces"><a id="white_nav" href="{{ url('gallery') }}">column</a></li>
						<li class="link-braces"><a id="white_nav" href="{{ url('contact') }}">contact</a></li>
					</ul>
				</div>
			</div>
		</header>
			...
			<div class="fs_menu_overlay_inner">
				...
				<div class="fs_menu_left">
					<div class="fs_menu_left_inner">
						...
						<div class="fs_menu_logo">Tennis</div>
					</div>
				</div>
				...
				<div class="fs_nav">
					<ul>
						...
						<li><a href="{{ url('about') }}">session</a></li>
						<li><a href="{{ url('service') }}">lifestyle</a></li>
						<li><a href="{{ url('service') }}">booking</a></li>
						<li><a href="{{ url('overseas') }}">column</a></li>
